...
import ru.yandex.praktikum.scooter.api.CourierModel;
import ru.yandex.praktikum.scooter.api.CreateRandomCourier;
...
public class CreateCourierTest {
    ...
    public void createCourierWithNonUniqueLogin() {
        String expectedError = "Этот логин уже используется. Попробуйте другой.";
